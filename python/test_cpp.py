...
import os
import sys
sys.path.append(os.path.abspath('../build/debug/lib'))
print(os.listdir(os.path.abspath('../build/debug/lib')))
import NRA_op

#%%
A=NRA_op.NRA_op("../benchmark/test/smalltest=>.smt2")
# %%
vs=A.vars()
print(len(vs))
print(vs[0])
...
print(A.str())
#%%
A=NRA_op.NRA_op("../benchmark/test/matrix-1-all-2.smt2",True)
# %%
vs=A.vars()
print(len(vs))
#%%
